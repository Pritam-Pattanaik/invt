  ...
  try {
    ...
    const dashboardData = {
      ...
      today: {
        ...
        averageOrderValue: todayOrders > 0 ? (todaySales._sum.finalAmount || 0) / todayOrders : 0,
      },
      monthly: {
        orders: monthlyOrders,
        sales: monthlySales._sum.finalAmount || 0,
        averageOrderValue: monthlyOrders > 0 ? (monthlySales._sum.finalAmount || 0) / monthlyOrders : 0,
      },
      yearly: {
        orders: yearlyOrders,
        sales: yearlySales._sum.finalAmount || 0,
